...
public class AvatarMenu extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        imageView2.setOnMouseClicked(mouseEvent -> {
            ProfileMenuController.currentuser.setAvatar(image2);
        });
        ...
        imageView3.setOnMouseClicked(mouseEvent -> {
            ProfileMenuController.currentuser.setAvatar(image3);
        });
        ...
        imageView4.setOnMouseClicked(mouseEvent -> {
            ProfileMenuController.currentuser.setAvatar(image4);
        });
        ...
        imageView5.setOnMouseClicked(mouseEvent -> {
            ProfileMenuController.currentuser.setAvatar(image5);
        });
        ...
        imageView6.setOnMouseClicked(mouseEvent -> {
            ProfileMenuController.currentuser.setAvatar(image6);
        });
        ...
        imageView7.setOnMouseClicked(mouseEvent -> {
            ProfileMenuController.currentuser.setAvatar(image7);
        });
        ...
        imageView8.setOnMouseClicked(mouseEvent -> {
            ProfileMenuController.currentuser.setAvatar(image8);
        });
        ...
        imageView9.setOnMouseClicked(mouseEvent -> {
            ProfileMenuController.currentuser.setAvatar(image9);
        });
        ...
        imageView10.setOnMouseClicked(mouseEvent -> {
            ProfileMenuController.currentuser.setAvatar(image10);
        });
