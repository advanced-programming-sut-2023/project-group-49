...
public enum Commands {
    ...
    LOGIN_VALID("user login -u (?<username>.*) -p (?<password>\\S*)(?<statLoggedIn>.*)"),
    FORGOT_PASSWORD("forgot my password .+"),
    SECURITY_QUESTION("question pick .+"),
    USER_LOGOUT("user logout"),
    USERNAME_CHANGE("profile change -u.+"),
    NICKNAME_CHANGE("profile change -n.+"),
    PASSWORD_CHANGE("profile change password .+"),
    EMAIL_CHANGE("profile change -e.+"),
